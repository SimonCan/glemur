...
extern int  one;        // Used for determining the endianness.
extern char *pEndian;
...
struct VarsDev {
    ...
    REAL    *uu_new;        // new velocity
    REAL    *uu_tmp;        // temporary velocity
...
extern __constant__ struct Parameters dev_params; // simulation parameters on the device
extern __constant__ REAL   a_i[6];                // coefficients a_i for the adaptive step size Runge-Kutta
extern __constant__ REAL   b_ij[7*6];             // coefficients b_ij for the adaptive step size Runge-Kutta
extern __constant__ REAL   c_i[6];                // coefficients c_i for the adaptive step size Runge-Kutta
extern __constant__ REAL   cs_i[6];               // coefficients c*_i for the adaptive step size Runge-Kutta
